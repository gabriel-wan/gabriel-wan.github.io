      ...
      <ul className="entries">
        <li className="entry-row">
          ...
          <div>
            ...
            <a className="btn btn-small" href="/testimonials/siaec-recommendation.pdf" target="_blank" rel="noopener">Testimonial<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 16 16 8M9 8h7v7" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg></a>
          </div>
        </li>
        <li className="entry-row">
          ...
          <div>
            ...
            <a className="btn btn-small" href="/testimonials/aimazing-recommendation.pdf" target="_blank" rel="noopener">Testimonial<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M8 16 16 8M9 8h7v7" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg></a>
          </div>
        </li>
      </ul>
    </section>
            ...
            <ul className="wheel-track">
              <li className="wheel-item">
                <a className="wheel-link" href="/projects/mini-gabriel">
                  <div className="art is-image is-chat"><img src="/images/mini-gabriel-wheel.webp" alt="A Telegram chat with the bot. I ask how far along it is with an assignment and it answers in three short lowercase messages" width="500" height="289" loading="lazy" /></div>
              ...
              <li className="wheel-item">
                <a className="wheel-link" href="/projects/lounge-booking">
                  <div className="art is-image"><img src="/images/lounge-booking.jpg" alt="The Lounge Booking app: a floor switcher, upcoming bookings and a calendar" width="450" height="850" loading="lazy" /></div>
              ...
              <li className="wheel-item">
                <a className="wheel-link" href="/projects/nus-gym-tracker">
                  <div className="art is-image is-fit" style={{ "--art-bg": "#220c00" } as CSSProperties}><img src="/images/gym-reddit-wheel.webp" alt="A post on r/nus asking when the least crowded time at the U-Town gym is" width="700" height="404" loading="lazy" /></div>
              ...
              <li className="wheel-item">
                <a className="wheel-link" href="/projects/kopikaki">
                  <div className="art is-image is-fit" style={{ "--art-bg": "#fffaf5" } as CSSProperties}><img src="/images/kopikaki-wheel.webp" alt="The KopiKaki app asking What do you feel like doing?, with its mascot and a Tap to speak button" width="762" height="440" loading="lazy" /></div>
              ...
              <li className="wheel-item">
                <a className="wheel-link" href="/projects/uwash">
                  <div className="art is-image"><img src="/images/uwash.jpg" alt="The UWash dashboard's usage chart" width="1465" height="739" loading="lazy" /></div>
              ...
              <li className="wheel-item">
                <a className="wheel-link" href="https://github.com/gabriel-wan/hackomania_interledger">
                  <div className="art is-image"><img src="/images/emergency-fund.jpg" alt="The Community Fund dashboard with a world map of disaster signals" width="1904" height="908" loading="lazy" /></div>
